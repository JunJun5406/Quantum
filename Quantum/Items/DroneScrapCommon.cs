...
namespace Quantum.Items
{
    ...
    {
        public static DroneScrapCommon DroneScrapCommon = new DroneScrapCommon
        (
            "DroneScrapCommon",
    ...
    public class DroneScrapCommon : ItemBase
    {
        ...
        {
            GameObject ret = Main.Assets.LoadAsset<GameObject>("Assets/prefabs/droneScrapItem1.prefab");
