...
namespace Quantum.Items
{
    ...
    {
        public static DroneScrapUncommon DroneScrapUncommon = new DroneScrapUncommon
        (
            "DroneScrapUncommon",
    ...
    public class DroneScrapUncommon : ItemBase
    {
        ...
        public Material material2 => Addressables.LoadAssetAsync<Material>("RoR2/Base/Clover/matClover.mat").WaitForCompletion();
        public Material material3 => Addressables.LoadAssetAsync<Material>("RoR2/Base/Titan/matTitan.mat").WaitForCompletion();
        public Material material4 => Addressables.LoadAssetAsync<Material>("RoR2/Base/MultiShopEquipmentTerminal/matMultishopEquipment.mat").WaitForCompletion();
        ...
        {
            GameObject ret = Main.Assets.LoadAsset<GameObject>("Assets/prefabs/droneScrapItem2.prefab");
        ...
        public override void FormatDescriptionTokens()
        {
            ...
            (
                ...
                (
                    ...
                    DroneScrap.DroneScrap_UncommonItemsNeeded.Value
                )
            );
